...
import com.cafe.cafeapi.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Authentification ouverte a tous
                        .requestMatchers("/api/auth/**").permitAll()
                        // Consultation du menu ouverte (le compte n'est requis que pour commander)
